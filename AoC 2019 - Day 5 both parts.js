...
let i = 0
iteration = 0
modifiedOpCode(input, prompt, iteration)

function modifiedOpCode(input, prompt) {
    while(true) {
        ...
        if (order === "5") {
            iteration = 3
            if (parseInt(numberArray[0]) !== 0) {
                iteration = parseInt(numberArray[1]) -i
